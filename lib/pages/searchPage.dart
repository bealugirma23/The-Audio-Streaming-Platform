  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        resizeToAvoidBottomInset:
            true, // Important: allows the UI to resize when keyboard appears
        body: SafeArea(
          child: Column(
            children: [
              Padding(
                ...
                child: Column(
                  mainAxisSize:
                      MainAxisSize.min, // Important: prevents infinite height
                  children: [
                    TextField(
                    ...
                    if (_showSuggestions &&
                      ...
                      Container(
                        // Changed to Container to prevent layout issues
